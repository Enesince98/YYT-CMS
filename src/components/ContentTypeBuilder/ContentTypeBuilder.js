...
const ContentTypeBuilder = () => {
  ...
  return (
   ...
   <legend>Create Content Type </legend>
      ...
      <div><button  id="preview" onClick={addField} class="btn btn--primary uppercase">
        Add new field
      </button>
      <button id="preview" onClick={previewTable} class="btn btn--primary uppercase">Preview</button>
</div>
